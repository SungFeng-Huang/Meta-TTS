...
def main(args, configs):
    ...
    train_dataset = Dataset(
        f"{preprocess_config['subsets']['train']}.txt", preprocess_config, train_config, sort=True, drop_last=True
    )
    val_dataset = Dataset(
        f"{preprocess_config['subsets']['val']}.txt", preprocess_config, train_config, sort=False, drop_last=False
    )
